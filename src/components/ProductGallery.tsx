...
const PRODUCTS: Product[] = [
  {
    ...
    description: 'High-quality submersible pumps for borewell applications with stainless steel construction.',
    price: 15000,
    category: 'Pump'
  },
  {
    ...
    description: 'Heavy-duty submersible cable for connecting pumps to power source.',
    price: 2500,
    category: 'Accessory'
  },
  {
    ...
    description: 'High-quality PVC pipes and fittings for borewell installation.',
    price: 3200,
    category: 'Accessory'
  },
  {
    ...
    description: 'Strong PVC casing pipes for borewell construction.',
    price: 4500,
    category: 'Accessory'
  },
  {
    ...
    description: 'Automatic water level controller for borewell pumps.',
    price: 5800,
    category: 'Accessory'
  },
  {
    ...
    description: 'Metal clamps for securing pipes in borewell installations.',
    price: 450,
    category: 'Accessory'
  }
];
