...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-borewell-800 text-white mt-auto">
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-col items-center space-y-4">
            ...
            {socialLinks.map((link) => {
              ...
              return (
                <a
                  ...
                  title={link.name === 'Phone' ? 'Call us at +91 9373261147' : `Follow us on ${link.name}`}
                >
          ...
          <div className="border-t border-borewell-600 pt-4 text-center text-xs text-borewell-300">
            ...
            <p className="mt-1">Developed with ❤️ by Onkar Chaugule</p>
          </div>
        </div>
      </div>
    </footer>
