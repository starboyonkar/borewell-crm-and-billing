          ...
          <CardContent>
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <TabsList className="grid grid-cols-2 mb-4">
                <TabsTrigger value="admin" className="bg-slate-400 hover:bg-slate-300 text-base font-bold">Admin Login</TabsTrigger>
                <TabsTrigger value="customer" className="text-inherit font-bold text-base bg-slate-400 hover:bg-slate-300">Customer</TabsTrigger>
              </TabsList>
